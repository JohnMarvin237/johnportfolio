        ...
        <div className="flex flex-col h-full">
              ...
              return (
                ...
                >
                  ...
                  {item.count !== undefined && (
                    <span className="ml-auto bg-gray-700 text-xs font-medium px-2 py-0.5 rounded-full">
                      {item.count}
                    </span>
                  )}
                </Link>
          ...
          <div className="px-4 py-4 border-t border-gray-800">
            ...
            <button
              ...
              className="flex items-center gap-3 px-3 py-2 w-full text-left text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
